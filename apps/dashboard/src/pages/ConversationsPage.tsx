...
export function ConversationsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Percakapan</h1>
        <p className="text-sm text-slate-500">Monitor obrolan bot secara realtime.</p>
      </div>
      <div className="grid h-[calc(100vh-180px)] grid-cols-1 overflow-hidden rounded-lg border border-slate-200 bg-white shadow-card lg:grid-cols-[360px_1fr]">
        <ConversationList
